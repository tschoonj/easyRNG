...
files = list(filter(lambda file: os.path.basename(file) == 'easyrng.mod', files))
if not files:
    sys.exit('easyrng.mod was not found!')

shutil.copy(files[0], os.path.join(install_destdir_prefix, 'include', 'easyRNG'))
